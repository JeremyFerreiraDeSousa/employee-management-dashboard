...
export default function InputErrorMsg({ message }: InputErrorMsgProps): JSX.Element {
  return (
    <p className="flex items-center gap-1 text-red-600 text-xs mt-1 flex-shrink-0">
      <ErrorIcon className="w-5 h-5 flex-shrink-0" /> {message}
    </p>
  )
}
